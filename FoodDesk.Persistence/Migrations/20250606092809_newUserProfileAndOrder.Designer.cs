...
namespace FoodDesk.Persistence.Migrations
{
    ...
    [Migration("20250606092809_newUserProfileAndOrder")]
    partial class newUserProfileAndOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDesk.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FoodDesk.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FoodDesk.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("FoodDesk.Domain.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodDesk.Domain.Entities.Product", b =>
                {
                    b.HasOne("FoodDesk.Domain.Entities.Category", "Category")
                        .WithMany("Products")
